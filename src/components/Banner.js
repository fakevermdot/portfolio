        ...
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left">
            <motion.h1
              ...
              className="text-[50px] font-semibold leading-[0.8] lg:text-[110px]"
            >
            ...
            >
              <a href="https://www.linkedin.com/in/ismail-el-habacha-7a5087250/" target="_blank" >
                <FaLinkedin />
              </a>
              <a href="https://github.com/fakevermdot" target="_blank">
                <FaGithub />
              </a>
            </motion.div>
          </div>
